...
const Post = props => {
  ...
  const date = props.date_published
    ? DateTime.fromISO(props.date_published)
    : null;
  ...
  return (
    <div className="card card--post" id={props._id}>
      <a
        ...
        onClick={e => props.openPost(e, props._id)}
      >
      ...
      <div className="card-content">
        ...
        <div className="is-size-7 has-text-grey metadata">
          ...
          <span className="metadata__item">{feed && feed.author}</span>
          <span className="metadata__item">{feed && feed.title}</span>
