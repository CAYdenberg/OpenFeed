...
export const actions = {
  updateValue: value => ({ type: c.UPDATE_VALUE, value }),
  ...
  newFeedRes: res => ({ type: c.NEW_FEED_RES, res }),

  newFeedError: status => ({ type: c.NEW_FEED_ERROR, status }),

  addFeedToDB: () => ({ type: c.ADD_FEED_TO_DB }),
