...
export const actions = {
  setView: view => ({ type: c.SET_VIEW, view }),

  setControlPanel: panel => ({ type: c.SET_CONTROL_PANEL, panel }),

  reqCloseMobile: () => ({ type: c.CLOSE_PANEL_MOBILE }),

  toggleHamburger: () => ({ type: c.TOGGLE_HAMBURGER }),
};
